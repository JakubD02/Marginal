...
from constants import CURRENCY_CODE_LENGTH, NAME_MAX_LENGTH, NAME_MIN_LENGTH, NOTES_MAX_LENGTH, PRICE_DECIMAL_PLACES, PRICE_MAX_DIGITS
...
class ScenarioUpdate(BaseModel):
    ...
    currency: str | None = Field(default=None, min_length=CURRENCY_CODE_LENGTH, max_length=CURRENCY_CODE_LENGTH)
...
class ProductUpdate(BaseModel):
    ...
    category: str | None = Field(default=None, min_length=NAME_MIN_LENGTH, max_length=NAME_MAX_LENGTH)
